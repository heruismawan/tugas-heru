...
public class LibrarySystem {
    ...
    public static void main(String[] args) {
        daftarBuku[i++] = new StoryBook("SB32F", "Makam Sunyi", 17, "Story", "SYAIFUL");
        daftarBuku[i++] = new HistoryBook("HB324", "Terang Bulan", 2, "History", "HERU");
        daftarBuku[i++] = new TextBook("TB323", "PADANG BULAN", 4, "Text", "IJUL");

        // Mengisi daftar mahasiswa
        studentList.add(0, new Student("202310370311177", "Heru isamawan Oktavianto", "Teknik","Mesin"));
        studentList.add(1, new Student("202310370311169", "Syaiful Hidayat", "Teknik","Informatika"));
        ...
        while (isRunning) {
            ...
            switch (choice) {
               ...
               0             Student student = new Student(nimStudent);
                            student.login();
                            break;
                        } else {
